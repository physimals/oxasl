...
def add_calib_options(parser, ignore=[]):
    ...
    g.add_option("-i", dest="img", help="Specify CBF image for calibration (ASL native space)")
    g.add_option("--of", dest="outfile", help="Output filename for calibrated image (defaut=<input_filename>_calib")
