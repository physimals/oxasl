...
Once the analysis had completed, view the final result::
    ...
    fsleyes oxasl/output/native/calib_refregion/perfusion_calib.nii.gz
...
To view the final result::
    ...
    fsleyes oxasl/output/native/calib_refregion/perfusion.nii.gz
...
directory:
  ...
  - ``oxasl/output/struct`` - this sub-drectory contains results
  ...
  - ``oxasl/output/native/calib_refrgion/perfusion_gm_mean.txt`` -
